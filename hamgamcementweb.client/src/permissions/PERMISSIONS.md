...
این سند مرجع اصلی برای افزودن، استفاده و نگهداری دسترسی‌ها در پروژه HamgamCementWeb است.
...
| `HamgamCementWeb.Server/.../User.cs` | `HasFullAccess` روی کاربر |
| `HamgamCementWeb.Server/.../UserPermission.cs` | کلیدهای عملیات |
