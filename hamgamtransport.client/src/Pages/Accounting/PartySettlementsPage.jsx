...
function PartySettlementsPage() {
  ...
  useEffect(() => {
    ...
    Promise.all([
      ...
      .then(([customerRows, supplierRows, ownerRows, driverRows, currencyRows, boxRows, bankRows]) => {
        if (cancelled) return
  ...
  const partyOptions = useMemo(() => {
    const type = Number(form.partyType)
                  ...
                  <div className="row g-3">
                    <div className="col-md-4">
                      ...
                      >
                        ...
                        <option value={PARTY_SUPPLIER}>تأمین‌کننده (پرداخت)</option>
                        <option value={PARTY_OWNER}>مالک وسیله (پرداخت)</option>
                        <option value={PARTY_DRIVER}>راننده (پرداخت)</option>
                      </select>
                    </div>
                    <div className="col-md-4">
