...
import { revenuesApi } from '../../services/financeApi'
...
function RevenuesReportPage() {
  ...
  const openJournalReport = () => {
    ...
    window.open(
      getJournalReportUrl('revenue', toLatinIsoDate(dateFrom) || dateFrom, toLatinIsoDate(dateTo) || dateTo),
      '_blank',
      'noopener,noreferrer',
    )
  }
  ...
  const tableOptions = useMemo(
    () => ({
      processing: true,
      serverSide: true,
      ajax: revenuesApi.createDataTableAjax(setLoadError),
      paging: true,
      searching: true,
      ordering: true,
      info: true,
      ...
      columns: [
        ...
        { data: 'customerName', name: 'customerName', title: 'مشتری', defaultContent: '—', orderable: false },
        {
          data: 'amount',
          name: 'amount',
          title: 'مبلغ',
  ...
  return (
    <div className="content-card card border-0">
      <div className="card-body p-4">
        <h2 className="card-title mb-2">گزارش عواید</h2>
        <p className="text-muted mb-4">
          فهرست عواید ثبت‌شده و امکان ساخت گزارش روزنامچه عواید در Stimulsoft.
        </p>
        ...
        <div className="row g-3 align-items-end mb-4">
          ...
          <div className="col-md-3">
            <button type="button" className="btn btn-primary w-100" onClick={openJournalReport}>
              گزارش روزنامچه عواید
            </button>
          </div>
        </div>

        <h3 className="h6 mb-3">فهرست عواید</h3>
...
export default RevenuesReportPage
