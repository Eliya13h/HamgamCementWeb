...
function CustomersPage() {
  ...
  const handleCreateSubmit = async (event) => {
    ...
    try {
      await createCustomer({
        ...
        customerType: Number(createForm.customerType),
  ...
  const handleEditSubmit = async (event) => {
    ...
    try {
      await updateCustomer(editRow.customerId, {
        name: editForm.name,
        ...
        customerType: Number(editForm.customerType),
  ...
  const handleDeleteConfirm = async () => {
    ...
    try {
      await deleteCustomer(deleteRow.customerId)
      closeModals()
      reloadTable()
    } catch (error) {
      setFormError(error.message)
              ...
              <form ref={createFormRef} className="modal-content" onSubmit={handleCreateSubmit}>
                ...
                <div className="modal-footer">
                  ...
                  <button type="submit" className="btn btn-accent" disabled={submitting}>
                    {submitting ? 'در حال ایجاد...' : 'ایجاد مشتری'}
                  </button>
                </div>
              </form>
            </div>
          ...
          <div className="modal show d-block users-modal" tabIndex="-1" role="dialog">
            <div className="modal-dialog modal-dialog-centered modal-dialog-scrollable">
              <div className="modal-content">
                <div className="modal-header">
                  <h5 className="modal-title">حذف مشتری</h5>
                  <button
                    type="button"
                    className="btn-close"
                    aria-label="بستن"
                ...
                <div className="modal-body">
                  ...
                  <p className="mb-0">
                    آیا از حذف مشتری <strong>{deleteRow.name}</strong> اطمینان دارید؟
                  </p>
                </div>
                <div className="modal-footer">
                  <button
