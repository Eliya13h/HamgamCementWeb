...
builder.Services.AddScoped<ICashBalanceService, CashBalanceService>();
        ...
        builder.Services.AddScoped<ITripPostingService, TripPostingService>();
...
builder.Services.AddAuthentication(CookieAuthenticationDefaults.AuthenticationScheme)
    .AddCookie(options =>
    {
        options.Cookie.Name = "HamgamTransport.Auth";
        options.Cookie.HttpOnly = true;
        options.Cookie.SameSite = SameSiteMode.Lax;
...
builder.Services.AddHamgamCurrencyReference(builder.Configuration, SystemCodes.Transport);
